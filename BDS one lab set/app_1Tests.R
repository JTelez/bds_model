...
ui <- fluidPage(
   ...
   fluidRow(
     column(3, 
            numericInput("tbili1", label = h5("TBili:"), value = NA)
     ), 
     # column(3,
     #        numericInput("tbili2", label = h5("Second TBili:"), value = NA)
     # ),
     column(3, 
            numericInput("AST1", label = h5("AST:"), value = NA)
     )
     # ,
     # column(3,
   ...
   fluidRow(
     column(3, 
            numericInput("ALT1", label = h5("ALT:"), value = NA)
     ), 
     # column(3,
     #        numericInput("ALT2", label = h5("Second ALT:"), value = NA)
     # ),
     column(3, 
            numericInput("ALP1", label = h5("ALP:"), value = NA)
     )
     # ,
     # column(3,
